...
export const gridItem6: GridItemConfig = {
  ...
  textContainerClassName:
    'absolute  top-0 pt-2 h-52 w-full bg-gradient-to-b rounded-b-3xl from-blue-500 via-blue-500 to-blue-500/0 dark:from-[#020621] dark:via-[#020621]/90 dark:to-[#020621]/0 z-30 text-slate-200 dark:text-white select-none ',
