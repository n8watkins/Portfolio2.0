    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 20 }}
          className="fixed bottom-4 right-4 z-[9999] bg-black/90 backdrop-blur-sm text-white p-4 rounded-lg shadow-2xl border border-white/20 font-mono text-xs"
              ...
              {Object.values(vitals)
                ...
                >
                  ...
                  <div className="text-right">
                    <div className={`font-bold ${getRatingTextColor(vital.rating)}`}>
...
WebVitalsHUD.displayName = 'WebVitalsHUD'
