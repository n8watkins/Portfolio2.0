  ...
  return (
    <div
      ...
      <ul
        ...
        className={cn(
          // change gap-16
          ' flex min-w-full shrink-0 1sm:gap-5 xs:gap-16 py-4 w-max flex-nowrap',
        ...
        {items.map((item, idx) => (
          <li
            ...
            className="w-[90vw] max-w-full relative rounded-2xl border border-b-0
             flex-shrink-0 border-slate-800 px-5 py-5 md:p-16 md:w-[60vw]"
            style={{
              //   background:
            ...
            <blockquote>
              ...
              <div className="relative z-20 mt-6 flex flex-row items-center">
                ...
                <div className="me-3 ">
                  <img src={item.image} className="w-14 h-14 rounded-full" alt="profile" />
                </div>
